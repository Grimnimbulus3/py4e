...
#Actual data: http://py4e-data.dr-chuck.net/comments_92028.json (Sum ends with 95)
...
#load  http://py4e-data.dr-chuck.net/comments_42.json using URLLIB
#Then parse the data into python
#Then compute the sum of numbers:(Sum=2553)
...
#print('Enter http://py4e-data.dr-chuck.net/comments_92028.json ')
